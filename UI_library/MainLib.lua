...
function Library:CreateWindow(options)
    ...
    function window:AddTab(options)
        ...
        if tabIcon and tabIcon ~= "" then
            local emoji = EmojiIcons:GetIcon(tabIcon)
            if emoji then
                -- Create text label for the emoji
                ...
                tabButton.MouseEnter:Connect(function()
                    iconLabel.TextColor3 = Library.CurrentTheme.AccentColor
                end)
                
                tabButton.MouseLeave:Connect(function()
                    iconLabel.TextColor3 = Library.CurrentTheme.PrimaryTextColor
                end)
            else
