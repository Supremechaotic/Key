        ...
        if tabIcon and tabIcon ~= "" then
            ...
            function tabMethods:AddDropdown(id, options)
                ...
                local dropdownButton = CreateInstance("TextButton", {
                    ...
                    BorderSizePixel = 0,
                    Position = UDim2.new(0, 10, 0, containerHeight - 30),
                ...
                local dropdownList = CreateInstance("ScrollingFrame", {
                    ...
                    BackgroundColor3 = Library.CurrentTheme.PrimaryElementColor,
                    BorderSizePixel = 0,
                    Position = UDim2.new(0, 10, 0, containerHeight - 5),
                ...
                game:GetService("UserInputService").InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 and open then
                        ...
                        if mousePosition.X < dropdownPosition.X or
                           mousePosition.X > dropdownPosition.X + dropdownSize.X or
                           mousePosition.Y < dropdownPosition.Y or
                           mousePosition.Y > dropdownPosition.Y + dropdownSize.Y then
                            toggleDropdown()
                        end
                    end
                end)
