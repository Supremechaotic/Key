    ...
    function window:AddTab(options)
        ...
        if tabIcon and tabIcon ~= "" then
            ...
            function tabMethods:AddColorpicker(id, options)
                ...
                local saturationPicker = nil
                local huePicker = nil
                local transparencyPicker = nil
                
                -- Function to create picker UI
                local function createPickerUI()
                    ...
                    saturationPicker = CreateInstance("ImageButton", {
                    ...
                    -- Rest of your picker UI creation code...
                end
