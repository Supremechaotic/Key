...
Library.Themes = {
    ...
    Light = {
        ...
        SidebarColor = Color3.fromRGB(240, 240, 242),
        PrimaryTextColor = Color3.fromRGB(0, 0, 0),
        SecondaryTextColor = Color3.fromRGB(100, 100, 100),
        UIStrokeColor = Color3.fromRGB(220, 220, 222),
        PrimaryElementColor = Color3.fromRGB(235, 235, 237),
        SecondaryElementColor = Color3.fromRGB(230, 230, 232),
        OtherElementColor = Color3.fromRGB(225, 225, 227),
        ScrollBarColor = Color3.fromRGB(220, 220, 222),
        PromptColor = Color3.fromRGB(235, 235, 237),
        NotificationColor = Color3.fromRGB(245, 245, 247),
        AccentColor = Color3.fromRGB(0, 122, 255)
    }
}
...
function Library:CreateWindow(options)
    ...
    function window:AddTab(options)
        ...
        local tabButton = CreateInstance("TextButton", {
            ...
            Position = UDim2.new(0, 6, 0, (tabIndex - 1) * 42),
            Font = Enum.Font.SFProText,
            Text = "",
