...
function Library:CreateWindow(options)
    ...
    function window:AddTab(options)
        ...
        -- Create tab button
    -- In the window:AddTab function, replace the tab button creation code with this:
    ...
    local tabButton = CreateInstance("TextButton", {
        ...
        Position = UDim2.new(0, 5, 0, (tabIndex - 1) * 37),
        Font = Enum.Font.Gotham,
    ...
    if tabIcon and tabIcon ~= "" then
        ...
        function tabMethods:AddDropdown(id, options)
            ...
            -- Need to update dropdown list position when UI changes
            ...
            local function toggleDropdown()
                ...
                if open then
                    -- Update position just before showing to ensure correct placement
                    dropdownList.Position = UDim2.fromOffset(
                        dropdownContainer.AbsolutePosition.X + 10, 
                        dropdownContainer.AbsolutePosition.Y + dropdownButton.AbsolutePosition.Y + dropdownButton.AbsoluteSize.Y + 5
                    )
            ...
            for i, value in ipairs(values) do
                local item = CreateInstance("TextButton", {
                    ...
                    TextSize = 14,
                    AutoButtonColor = false,
                    ZIndex = 11 -- Higher than the dropdown list
                })
