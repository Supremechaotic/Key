...
Library.TabCount = 0
Library.Tabs = {}
Library.Options = {} -- Initialize Options table
Library.ActiveTab = 1
Library.WindowInstance = nil
Library.CurrentTheme = nil

-- Import Lucide Icons
local LucideIcons = loadstring(game:HttpGet("https://raw.githubusercontent.com/Supremechaotic/Key/refs/heads/main/UI_library/LucideIcons.lua"))()
...
Library.Themes = {
    ...
    Light = {
        BackgroundColor = Color3.fromRGB(242, 242, 245),
        SidebarColor = Color3.fromRGB(235, 235, 238),
        PrimaryTextColor = Color3.fromRGB(0, 0, 0),
        SecondaryTextColor = Color3.fromRGB(75, 75, 75),
        UIStrokeColor = Color3.fromRGB(210, 210, 213),
        PrimaryElementColor = Color3.fromRGB(220, 220, 223),
        SecondaryElementColor = Color3.fromRGB(215, 215, 218),
        OtherElementColor = Color3.fromRGB(210, 210, 213),
        ScrollBarColor = Color3.fromRGB(215, 215, 218),
        PromptColor = Color3.fromRGB(220, 220, 223),
        NotificationColor = Color3.fromRGB(242, 242, 245),
        AccentColor = Color3.fromRGB(0, 122, 255)
    }
}
...
function Library:CreateWindow(options)
    ...
    local contentFrame = CreateInstance("Frame", {
        ...
        ClipsDescendants = true  -- Changed to true
    })
    ...
    function window:AddTab(options)
        ...
        if tabIcon and tabIcon ~= "" then
            local iconImage = LucideIcons:GetIcon(tabIcon)
            if iconImage then
                iconImage.Name = "Icon"
                iconImage.Parent = tabButton
                iconImage.Position = UDim2.new(0, 16, 0.5, -8)
                iconImage.Size = UDim2.new(0, 16, 0, 16)
                iconImage.ImageColor3 = Library.CurrentTheme.PrimaryTextColor
                iconImage.ZIndex = 3
                ...
                tabButton.MouseEnter:Connect(function()
                    iconImage.ImageColor3 = Library.CurrentTheme.AccentColor
                end)
                ...
                -- If icon not found, just set the button text directly with padding
            ...
            function tabMethods:AddToggle(id, options)
                ...
                -- Initialize the option in Library.Options
                Library.Options[id] = {
                    Value = enabled,
                    Type = "Toggle",
                ...
                toggleBackground.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseButton1 then
                        ...
                        -- Update option value
                        Library.Options[id].Value = enabled
            ...
            function tabMethods:AddSlider(id, options)
                ...
                local sliderBar = CreateInstance("Frame", {
                    ...
                    BorderSizePixel = 0,
                    Position = UDim2.new(0, 10, 0, description ~= "" and 56 or 30),
            ...
            function tabMethods:AddDropdown(id, options)
                ...
                local function toggleDropdown()
                    ...
                    if open then
                        ...
                        -- Position the list below the container
                        dropdownList.Position = UDim2.new(0, containerPos.X + 10, 0, containerPos.Y + containerSize.Y - 5)
