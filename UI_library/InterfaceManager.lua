        ...
        if mainFrame then
            ...
            if titleBar then
                ...
                if closeButton then
                    ...
                    closeButton.BackgroundColor3 = themeData.SidebarColor
                    
                    local hoverFrame = closeButton:FindFirstChild("HoverFrame")
                    if hoverFrame then
                ...
                if minimizeButton then
                    ...
                    minimizeButton.BackgroundColor3 = themeData.SidebarColor
                    
                    local hoverFrame = minimizeButton:FindFirstChild("HoverFrame")
                    if hoverFrame then
                        hoverFrame.BackgroundColor3 = themeData.AccentColor
                    end
                end
            ...
            if sidebar then
                ...
                if tabContainer then
                    ...
                    tabContainer.BackgroundColor3 = themeData.SidebarColor
                    ...
                    for _, tab in pairs(self.Library.Tabs) do
                        if tab.Button then
                            ...
                            -- Update hover frame
                            local hoverFrame = tab.Button:FindFirstChild("HoverFrame")
                            if hoverFrame then
                                hoverFrame.BackgroundColor3 = themeData.AccentColor
                            end
                        end
                        ...
                        -- Update tab content
                        if tab.Content then
                            tab.Content.BackgroundColor3 = themeData.BackgroundColor
            ...
            if contentFrame then
                contentFrame.BackgroundColor3 = themeData.BackgroundColor
            end
